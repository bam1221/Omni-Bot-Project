...
//HollowBody();
BottomBody();
//cylinder( d=15, 30, true, $fn=6) ;   //For bottom nut
//scale([1, 1, (N20_height+1)/N20_height]) translate([0, 80, 0]) Motor();
//Camera();
//Branding();
//translate([0, 0, 60]) TopBody();
//MagnetBody();
//rotate([0, 180, 0]) translate([0, 0, -50]) TopBody();
translate([0, 0, 20]) TopBody();

// color("red") rotate([0, 0, 0]) translate([-9, 76.9, -5]) cylinder( d=2, 20, true) ;
// rotate([0, 0, 0)] translate([9.5, 76.9, 0]) cylinder( d=2, 10, true) ;

//translate([0, 80, rounding]) Motor();
...
//  color("red") rotate([0, 0, 0]) translate([-9, 76.9, -5]) cylinder( d=2, 20, true) ;
//  color("red") rotate([0, 0, 0]) translate([9.5, 76.9, -5]) cylinder( d=2, 20, true) ;
//}
//rotate([0, 0, 0]) MountingHoles();
//rotate([0, 0, 120]) MountingHoles();
//rotate([0, 0, 240]) MountingHoles();
...
module BottomBody() {
  ...
  rotate([0, 0, 0]) scale([(N20_width+2)/N20_width, 1, (N20_height+2)/N20_height]) translate([0, 80, 0]) Motor();  
  rotate([0, 0, 120]) scale([(N20_width+2)/N20_width, 1, (N20_height+2)/N20_height]) translate([0, 80, 0]) Motor();  
  rotate([0, 0, 240]) scale([(N20_width+2)/N20_width, 1, (N20_height+2)/N20_height]) translate([0, 80, 0]) Motor(); 
  rotate([0, 0, 0]) MountingHoles();
  rotate([0, 0, 120]) MountingHoles();
  rotate([0, 0, 240]) MountingHoles();
  rpiMountingHoles();
    translate([0, 0, -rounding-2.1]) {
    rotate([0, 0, 0]) MagnetHoles() ;
    rotate([0, 0, 120]) MagnetHoles() ;
    rotate([0, 0, 240]) MagnetHoles() ;
    }
 }
...
module MagnetBody() {
color("yellow") rotate([0, 0, 0]) translate([28, 84.2, 34.4]) MagnetBody1() ;
color("yellow") rotate([0, 0, 0]) translate([-28, 84.2, 34.4]) MagnetBody2() ;
}

module MagnetBody1() {
translate([0, 0, -1]) cylinder( lid_thinkness*2+1, r=4.5, true) ;
rotate([10, -10, 0]) translate([0, 0, -lid_thinkness*2]) cylinder(h=lid_thinkness*2, r1=0, r2=4.6, center=false) ;
}
...
module TopSecure() {
rotate([0, 0, 0]) translate([0, -46.5, 62]) rotate([0, 0, 90]) cube([3,20,9],true);
rotate([0, 0, 120]) translate([0, -46.5, 62]) rotate([0, 0, 90]) cube([3,20,9],true);
rotate([0, 0, 240]) translate([0, -46.5, 62]) rotate([0, 0, 90]) cube([3,20,9],true);
}

module MagnetHoles() {
color("red") rotate([0, 0, 0]) translate([28, 84.2, 39.4]) cylinder( d=5.1, 2.1,true) ;
color("red") rotate([0, 0, 0]) translate([-28, 84.2, 39.4]) cylinder( d=5.1, 2.1,true) ;
}
...
module rpiMountingHoles() {
  color("red") rotate([0, 0, 0]) translate([-24.5, -19, -5]) cylinder( d=2.5, 20, true) ;
  color("red") rotate([0, 0, 0]) translate([-24.5, 39, -5]) cylinder( d=2.5, 20, true) ;
  color("red") rotate([0, 0, 0]) translate([24.5, -19, -5]) cylinder( d=2.5, 20, true) ;
  color("red") rotate([0, 0, 0]) translate([24.5, 39, -5]) cylinder( d=2.5, 20, true) ;
}


module MagnetPillarBody(){
translate([0, 0, -4]) {
color("yellow") rotate([0, 0, 0]) translate([0, 0, 0]) MagnetBody() ;
color("yellow") rotate([0, 0, 120]) translate([0, 0, 0]) MagnetBody() ;
color("yellow") rotate([0, 0, 240]) translate([0, 0, 0]) MagnetBody() ;
    }
}
module MagnetPillar() {
difference() {
